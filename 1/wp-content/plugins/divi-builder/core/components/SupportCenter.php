...
class ET_Core_SupportCenter {
	...
	public function add_support_center() {
		...
		if ( in_array( 'et_support', $current_user->roles, true ) ) {
			$is_current_user_et_support = 1;
		}

		if ( in_array( 'administrator', $current_user->roles, true ) && $this->support_user_account_name === $current_user->user_login ) {
